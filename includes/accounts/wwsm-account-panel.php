...
final class Panel {
	...
	public function new_account_panel() {
		...
		<div class="add-account-panel">
			...
			<a class="add-account-panel-dismiss" href="#add-account-dismiss" aria-label="<?php esc_attr_e( 'Hide the Add Account panel', 'support-me' ); ?>"><?php echo esc_html_x( 'Hide', 'add account panel', 'support-me' ); ?></a>
			...
			<div class="add-account-result">
				...
				<blockquote>
					<span class="wwsm-username"><?php printf( __( '<strong>Username:</strong> %s', 'support-me' ), '<span class="username-result"></span>' ); ?></span>
					<span class="wwsm-token"><?php printf( __( '<strong>Password URL:</strong> %s', 'support-me' ), '<span class="token-result"></span>' ); ?></span>
					<p>
						<span class="wwsm-expires"><?php printf( __( '<strong>Account Expires:</strong> %s', 'support-me' ), '<span class="expires-result"></span>' ); ?></span>
					</p>
				</blockquote>

				<p>
					<button id="wwsm-close" class="button button-primary"><?php esc_html_e( 'Close', 'support-me' ); ?></button>
			...
			<form id="add-account-panel-form" aria-expanded="false">
						...
						<td>
							<fieldset>
								...
								<label class="wwsm-choice">
									...
									<?php esc_html_e( 'Expires in: ', 'support-me' ); ?>
									...
									<select id="expire-interval" name="expire-interval" class="expire-interval">
										<option value="minutes"><?php esc_html_e( 'Minutes', 'support-me' ); ?></option>
										<option value="hours" selected="selected"><?php esc_html_e( 'Hours', 'support-me' ); ?></option>
										<option value="days"><?php esc_html_e( 'Days', 'support-me' ); ?></option>
									</select>
									<p>
				...
				<input type="submit" id="add-account-submit" class="button button-primary" value="<?php esc_attr_e( 'Add Account', 'support-me' ); ?>" />
			</form>
		</div>
		<?php
	}
